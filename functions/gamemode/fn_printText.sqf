    ...
    { 
        ...
        { 
            ...
            //print the output 
            [(_processedTextF + _blockTextF_), 0, 0.15, 1, 0, 0, 90] spawn BIS_fnc_dynamicText; 
            //playSound "click"; 
            sleep 0.08; 
            [(_processedTextF + _blockTextF), 0, 0.15, 1, 0, 0, 90] spawn BIS_fnc_dynamicText; 
            sleep 0.02; 
        } 
        forEach _blockArray; 
    ...
    //clean the screen 
    ["", 0, 0.15, 2, 0, 0, 90] spawn BIS_fnc_dynamicText; 
