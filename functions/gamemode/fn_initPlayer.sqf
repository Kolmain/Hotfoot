...
_loadouts = [side player] spawn KOL_fnc_initPlayerLoadout;
...
player createDiaryRecord ["Intel", ["Friendly Forces", "Friendly forces will be accompanying your team in the assault. Additional support assets are available and will be standing by. In addition to infantry fireteams, HQ will be providing QRF, UGV, and fire support from surrounding batteries."]];
_task = player createsimpletask ["obj0"];
_task setsimpletaskdescription ["Assault and secure the city of Pyrgos. Minimize civilian impact and counter-attacka any OPFOR infantry within the city.", "ASSAULT PYRGOS", "ASSAULT"];
