class CfgRespawnInventory {
	...
	class grenadier_west
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_PlateCarrierGL_rgr","H_HelmetSpecB_blk","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	...
	class sniper_west
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_Chestrig_rgr","","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
	...
	class grenadier_east
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_HarnessOGL_brn","H_HelmetLeaderO_ocamo","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	...
	class at_east
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_TacVest_khk","H_HelmetO_ocamo","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	...
	class sniper_east
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_Chestrig_khk","","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
	...
	class grenadier_guer
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_PlateCarrierIAGL_dgtl","H_HelmetIA_net","G_Tactical_Black","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
	...
	class specops_guer
	{
		...
		items[] = {"FirstAidKit"};
		linkedItems[] = {"V_Chestrig_oli","","","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS"};
