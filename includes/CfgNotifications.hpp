class CfgHints
{
	class Gamemode
	{
		...
		class kill
		{
            ...
            tip = "If you do not receive the kill notification, it doesn't mean you didn't necessarily secure the kill, only you did not see it.";
			arguments[] = {};
			image = "\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			noImage = false;
		};
		...
		class epilogue
		{
			...
			description = "Once the fate of the objective has been secured, the mission will enter the epilogue. Units of the losing faction(s) will need to make their way to the %3extraction point%4 for immediate exfiltration, while units of the winning faction(s) will attempt to %3eliminate the retreating forces%4. Successfully exfilitrating from the area of operation will result in bonus points being applied to your rank.";
            tip = "There is no point deduction for not making it to the extraction point, so you may choose to enact guerilla tactics to secure your own bonus points and protect your retreating comrades.";
			arguments[] = {};
			image = "\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			noImage = false;
		};
	...
	class Support
	{
		...
		class mortarStrike
		{
			...
			displayNameShort = "Requesting Mortar Support";
			description = "Mortar fire is a light precise strike effective against well defended targets.%1<t></t>1. Point at the target, or hover your mouse on the location on the map, or hover your mouse on the location on the map.%1<t></t>2. Press %3[0]%4 to enter the command menu.%1<t></t>3. Select %3Communications%4 - %3[8]%4.%1<t></t>4. Select %3Mortar Strike%4.%1<t></t> Mortar support will then confirm the request and report the splash. <t></t> If the coordinates that you sent are unable to be used, the supporting unit will grant you another request.";
			tip = "Make sure there are no friendly forces in the vicinity of your target. You will be held accountable for friendly fire incidents.";
			arguments[] = {};
			image = "\a3\ui_f\data\gui\cfg\hints\ArtilleryCall_ca.paa";
			noImage = false;
		...
		class fixedCasStrike
		{
			...
			description = "CAS is a precise strike effective against well defended targets.%1<t></t>1. Point at the target, or hover your mouse on the location on the map.%1<t></t>2. Press %3[0]%4 to enter the command menu.%1<t></t>3. Select %3Communications%4 - %3[8]%4.%1<t></t>4. Select %3CAS Strike%4.%1<t></t> The pilot will then confirm the request and execute the order. <t></t> If the coordinates that you sent are unable to be used, the supporting unit will grant you another request.";
			tip = "Make sure there are no friendly forces in the vicinity of your target. You will be held accountable for friendly fire incidents.";
			arguments[] = {};
			image = "\a3\ui_f\data\gui\cfg\hints\ArtilleryCall_ca.paa";
			noImage = false;
		...
		class qrfRequest
		{
			...
			description = "A quick reaction force is an easily mobilized, mechanized fire team.%1<t></t>1. Point at the target, or hover your mouse on the location on the map.%1<t></t>2. Press %3[0]%4 to enter the command menu.%1<t></t>3. Select %3Communications%4 - %3[8]%4.%1<t></t>4. Select %3QRF Request%4.%1<t></t> Command will then confirm the request and dispatch the friendly forces to the requested location. <t></t> If the coordinates that you sent are unable to be used, the supporting unit will grant you another request.";
		...
		class ugvRequest
		{
			...
			description = "An unmanned ground vehicle reduces the risk to friendly forces, while providing reinforcement and additional fire-power to existing allied forces.%1<t></t>1. Point at the target, or hover your mouse on the location on the map.%1<t></t>2. Press %3[0]%4 to enter the command menu.%1<t></t>3. Select %3Communications%4 - %3[8]%4.%1<t></t>4. Select %3UGV Request%4.%1<t></t> Command will then confirm the request and dispatch the UGV to the requested location. <t></t> If the coordinates that you sent are unable to be used, the supporting unit will grant you another request.";
